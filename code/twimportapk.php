...
foreach($resurt['data'] as $v){
	...
	/*//判定控制方式
	$contype = array('1'=>'智能体感手柄','2'=>'遥控器','3'=>'智能体感手柄,遥控器','4'=>'手机','5'=>'智能体感手柄,手机','6'=>'遥控器,手机','7'=>'智能体感手柄,遥控器,手机','8'=>'游戏手柄','9'=>'游戏手柄,智能体感手柄','10'=>'游戏手柄,遥控器','11'=>'游戏手柄,智能体感手柄,遥控器','12'=>'游戏手柄,手机','13'=>'游戏手柄,智能体感手柄,手机','14'=>'游戏手柄,遥控器,手机','15'=>'游戏手柄,智能体感手柄,遥控器,手机');
	foreach($contype as $ke=>$vts){
		if($controller_type==$ke){
			$controller = $vts;continue;
		}
	}*/
	...
	if(empty($ss1['app_id'])){
		$sql2="INSERT INTO `app` (`app_name`, `spell`, `app_desc`, `channel_cat_id`, `language`, `packagename`, `os_ver`, `tag`, `view_count`, `download_count`, `create_time`, `update_time`, `status`, `channel`, `type`, `version`, `price`, `owner`, `controller_type`, `versioncode`)VALUES
('$title', '$pingying', '$desc', '$channel_cat_id', '$languages', '$package_name', '$os', '$tagsname', 12, 238463, '$create_time', '$update_time', 1, '$aptype', '$aptype', '$version', '$price_type', '$producer', '$controller_type', '$version_code')";
		//echo $sql2."\n";
		$db_show->query ( $sql2 );
		...
		//导入的应用记录导入日志
		$tt = time();
		$sql7="INSERT INTO `app_onlinelog` (`app_id`, `packagename`, `status`, `createtime`, `reason`, `source`) VALUES ('$app_id', '$package_name', 'import', '$tt', '导入', 'world')";
		$db_show->query ( $sql7 );
		echo 'one ok!'."\n";
	}else{
		echo '111'."\n";
