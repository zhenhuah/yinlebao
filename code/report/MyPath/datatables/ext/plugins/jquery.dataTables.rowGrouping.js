    ...
    $.fn.rowGrouping = function (options) {
        ...
        return this.each(function (index, elem) {
            ...
            function _fnGetCleanedGroup(sGroup) {
                ...
                if(sGroup.constructor==String)  return sGroup.toLowerCase().replace(/[^a-zA-Z0-9\u0080-\uFFFF]+/g, "-"); //fix for unicode characters (Issue 23)
                else {
                		
										if(sGroup['name']===null && sGroup['id']===null) {
											//console.log(sGroup['id']);
											
											//sGroup['name']="main menu";
											return  "-";
										}
										else if(sGroup['name']===null) return "Unknown"	 ;
										return  sGroup['name'].toLowerCase().replace(/[^a-zA-Z0-9\u0080-\uFFFF]+/g, "-");
                }
