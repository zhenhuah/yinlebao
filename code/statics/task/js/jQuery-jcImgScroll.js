			...
			var _SELF = $(this),
				...
				object = function(length){
					...
					this.arrow = function(l,r,w,h,x,y){
						return "<a class=\"sPrev\" id=\"sPrev\" style=\"position:absolute;cursor:pointer;z-index:10;width:"+w+"px;height:"+h+"px;left:"+(l-w-x)+"px;\"></a><a class=\"sNext\" id=\"sNext\" style=\"position:absolute;cursor:pointer;z-index:10;width:"+w+"px;height:"+h+"px;left:"+(r+x-70)+"px;top:"+y+"px;\"></a>";
					};
					this.hoverDom = function(t,w,h,b,bg,p,c,lh){
						return "<b style=\"display:none;text-align:center;padding:0 "+p+"px;width:"+(w-p*2-b*2+16)+"px;color:"+c+";text-shadow:none;background:"+"#000"+";position:absolute;z-index:2;left:"+25+"px;bottom:"+26+"px;height:0px;overflow:hidden;line-height:"+(lh+5)+"px;\">"+ t + "" +"</b>";
					};
				};
			//初始化获取DOM数据
