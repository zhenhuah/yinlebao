...
<div class="table-list">
    <table width="100%" cellspacing="0" >
        <thead>
            <tr>
			  <th align="left" width="80">modelid</th>
              <th align="left" width="130"><?php echo L('model_name');?></th>
			  <th align="left" width="130"><?php echo L('tablename');?></th>
              <th align="left"><?php echo L('description');?></th>
              <th align="left" width="100"><?php echo L('status');?></th>
              <th align="left" width="100"><?php echo L('items');?></th>
			  <th align="left" width="230"><?php echo L('operations_manage');?></th>
            </tr>
        </thead>
    <tbody>
	<?php
    ...
    <tr>
		...
		<td align='left'><?php echo $r['tablename']?></td>
		<td align='left'>&nbsp;<?php echo $r['description']?></td>
		<td align='left'><?php echo $r['disabled'] ? L('icon_locked') : L('icon_unlock')?></td>
		<td align='left'><?php echo $r['items']?></td>
		<td align='left'>
