...
<form name="myform" id="myform" action="?m=content&c=content&a=add" onSubmit="return verifyForm()" method="post" enctype="multipart/form-data">
		  ...
		  <div class="demo">
		     ...
		     <?php 
				if($_SESSION['roleid'] != '1')
					...
					$cidarr = array('GO3CKTV','GO3CKTVTEST','ZYDQ','WMMY','FSTLM');
		     ?>
		     ...
		     <input type="hidden" value="" id="cidStr" name="info[cidStr]">
		  </div>
	</td>
 </tr>
<?php }?>
