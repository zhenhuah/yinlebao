...
<table cellpadding="2" cellspacing="1" onclick="javascript:$('#minlength').val(0);$('#maxlength').val(255);">
	<tr> 
      <td>显示类型</td>
      <td><input name="setting[link_type]" type="radio" value="1" checked /> 自动显示 <input name="setting[link_type]" type="radio" value="2" /> 其他显示</td><!--input name="setting[link_type]" type="radio" value="0" /> 搜索显示</td-->
    </tr>
	<tr> 
      <td>关联表名</td>
      <td>
...
//-->
	...
	<tr> 
      ...
      <td><input type="text" name="setting[size]" value="40" size="40" class="input-text"></td>
    </tr>
</table>
