	...
	public function init () {
		...
		if(!empty($result)) {
			foreach($result as $r) {
				...
				$r[stb_img]   = $r[stb]   ? '<img src="/statics/images/admin_img/ext_on.gif" />' : '<img src="/statics/images/admin_img/ext_off.gif" />';
				$r[pad_img]   = $r[pad]   ? '<img src="/statics/images/admin_img/ext_on.gif" />' : '<img src="/statics/images/admin_img/ext_off.gif" />';
				$r[phone_img] = $r[phone] ? '<img src="/statics/images/admin_img/ext_on.gif" />' : '<img src="/statics/images/admin_img/ext_off.gif" />';
				$r[pc_img]    = $r[pc]    ? '<img src="/statics/images/admin_img/ext_on.gif" />' : '<img src="/statics/images/admin_img/ext_off.gif" />';
		...
		$str  = "<tr>
					...
					<!--
					<td align='center' style='color:blue'>\$stb_img</td>
					<td align='center' style='color:blue'>\$pad_img</td>
					<td align='center' style='color:blue'>\$phone_img</td>
					<td align='center' style='color:blue'>\$pc_img</td>
					-->
