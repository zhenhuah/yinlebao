...
<td>
<input type="text" name="info[email]" value="<?php echo time().'@qq.com'; ?>" class="input-text" id="email" size="30"></input>
</td>
</tr>
<tr>
<td>SPID</td> 
...
<input type="checkbox" name="spid[]" value="<?php echo $spid['spid']?>"> <?php echo $spid['spid']?>&nbsp;
<?php }	?>
</td>
</tr>
<tr>
