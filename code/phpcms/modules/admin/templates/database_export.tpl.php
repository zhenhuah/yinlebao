...
?>   
    ...
    <thead>
       <tr>
           <th width="10%"><input type="checkbox" value="" id="check_box" checked="checked" onclick="selectall('tables[]');"> <a class="cu" href="javascript:void(0);" onclick="reselect()"><?php echo L('reselect')?></a></th>
	...
	<tr>
	<td  width="5%" align="center"><input type="checkbox" name="tables[]" checked="checked" value="<?php echo $v['name']?>"/></td>
