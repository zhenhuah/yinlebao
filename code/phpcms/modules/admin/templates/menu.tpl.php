...
<?php echo $select_categorys;?>
	...
	<tr>
	  ...
	  <tr>
        <th><?php echo L('type_link')?>：</th>
        <td><input type="radio" name="info[type]" value="1" checked><?php echo L('no')?> <input type="radio" name="info[type]" value="0"> <?php echo L('yes')?></td>
      </tr>
	  <tr>
        <th><?php echo L('hyperlinks')?>：</th>
        <td><input type="text" name="info[hyperlinks]" class="input-text" ></td>
      </tr>
</table>
<!--table_form_off-->
</div>
...
<?php echo $select_categorys;?>
	...
	<tr>
        <th><?php echo L('type_link')?>：</th>
        <td><input type="radio" name="info[type]" value="1" <?php if($type) echo 'checked';?>><?php echo L('no')?> <input type="radio" name="info[type]" value="0" <?php if(!$type) echo 'checked';?>> <?php echo L('yes')?></td>
      </tr>
	  <tr>
        <th><?php echo L('hyperlinks')?>：</th>
        <td><input type="text" name="info[hyperlinks]" class="input-text" value="<?php echo $hyperlinks?>"></td>
      </tr>
</table>
<!--table_form_off-->
</div>
