...
<table width="100%" class="table_form ">
    ...
    <tr>
     <th>发布到STB：</th>
      <td>
	  <input type='radio' name='info[stb]' value='1'  <?php if($stb) echo 'checked';?>> <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
	  <input type='radio' name='info[stb]' value='0'  <?php if(!$stb) echo 'checked';?>> <?php echo L('no');?></td>
    </tr>
    <tr>
     <th>发布到PAD：</th>
      <td>
	  <input type='radio' name='info[pad]' value='1' <?php if($pad) echo 'checked';?>> <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
	  <input type='radio' name='info[pad]' value='0' <?php if(!$pad) echo 'checked';?>> <?php echo L('no');?></td>
    </tr>
    <tr>
     <th>发布到PHONE：</th>
      <td>
	  <input type='radio' name='info[phone]' value='1' <?php if($phone) echo 'checked';?>> <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
	  <input type='radio' name='info[phone]' value='0' <?php if(!$phone) echo 'checked';?>> <?php echo L('no');?></td>
    </tr>
    <tr>
     <th>发布到PC：</th>
      <td>
	  <input type='radio' name='info[pc]' value='1' <?php if($pc) echo 'checked';?>> <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
	  <input type='radio' name='info[pc]' value='0' <?php if(!$pc) echo 'checked';?>> <?php echo L('no');?></td>
    </tr>
    -->
</table>
