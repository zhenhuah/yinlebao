...
<div class="col-2 lf mr10" style="width:48%">
  ...
  <div class="content"> <?php echo L('main_hello')?><?php echo $admin_username?><br />
...
<div class="col-2 col-auto">
  ...
  <div class="content"> <?php echo L('main_os')?><?php echo $sysinfo['os']?> <br />
	...
	<?php echo L('main_cms_vesion')?>V1.2.4<br />
	<?php echo L('main_go3c_vesion')?>V1.2.4<br />
	<?php echo L('main_bigtv_vesion')?>V1.2.2<br />
  </div>
</div>
<div class="bk10"></div>
...
<h6>Update Caches</h6>
<div class="content" id="update_tips" style="height:90px; overflow:auto;">
