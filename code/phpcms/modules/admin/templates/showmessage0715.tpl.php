...
.showMsg{border: 1px solid #1e64c8; zoom:1; width:550px; height:272px;position:absolute;top:44%;left:50%;margin:-87px 0 0 -225px}
...
.showMsg .bottom{ background:#e4ecf7; margin: 50px 1px 1px 1px;line-height:26px; *line-height:30px; height:26px; text-align:center}
...
<div class="showMsg" style="text-align:center">
    ...
    <div class="content guery" style="display:inline-block;display:-moz-inline-stack;zoom:1;*display:inline;max-width:480px"><?php echo $msg?></div>
    <div class="bottom">
