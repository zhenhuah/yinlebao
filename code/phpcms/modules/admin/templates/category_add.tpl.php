...
<table width="100%" class="table_form ">
 <tr>
	...
	<tr id="catdir_tr" style="display:none;">
        ...
        <td><input type="text" name="info[catdir]" id="catdir" class="input-text" value="<?php echo time();?>"></td>
      </tr>
	<tr>
    ...
    <tr>
     <th><?php echo L('ismenu');?>：</th>
      <td>
	  <input type='radio' name='info[ismenu]' value='1' > <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
	  <input type='radio' name='info[ismenu]' value='0' checked> <?php echo L('no');?></td>
    </tr>
    <!--
    <tr>
     <th>发布到STB：</th>
      <td>
	  <input type='radio' name='info[stb]' value='1' checked> <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
	  <input type='radio' name='info[stb]' value='0'  > <?php echo L('no');?></td>
    </tr>
    <tr>
     <th>发布到PAD：</th>
      <td>
	  <input type='radio' name='info[pad]' value='1' checked> <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
	  <input type='radio' name='info[pad]' value='0'  > <?php echo L('no');?></td>
    </tr>
    <tr>
     <th>发布到PHONE：</th>
      <td>
	  <input type='radio' name='info[phone]' value='1' checked> <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
	  <input type='radio' name='info[phone]' value='0'  > <?php echo L('no');?></td>
    </tr>
    <tr>
     <th>发布到PC：</th>
      <td>
	  <input type='radio' name='info[pc]' value='1' checked> <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
	  <input type='radio' name='info[pc]' value='0'  > <?php echo L('no');?></td>
    </tr>
    -->
</table>
