...
<div class="table-list">
    <table width="100%" cellspacing="0" >
        <thead>
            ...
            <th align='left' width="120"><?php echo L('modelname');?></th>
            <th align='center' width="40"><?php echo L('items');?></th>
            <th align='center' width="30"><?php echo L('vistor');?></th>
            <!--
            <th align='center' width="30" style="color:blue;">STB</th>
            <th align='center' width="30" style="color:blue;">PAD</th>
            <th align='center' width="40" style="color:blue;">PHONE</th>
            <th align='center' width="30" style="color:blue;">PC</th>
			-->
