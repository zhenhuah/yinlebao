...
<div class="header">
	<div class="logo lf"><a href="index.php?m=admin&c=index"><span class="invisible"><?php echo L('phpcms_title')?></span></a></div>
    <!--
    <div class="rt-col">
    ...
    <div class="col-auto">
    	<div class="log white cut_line">
			<?php echo L('hello'),$admin_username?>  [<?php echo $rolename?>]<span>|</span>
            <a href="?m=admin&c=index&a=public_logout">[<?php echo L('exit')?>]</a><span>|</span>
    		<!--
...
<div id="content">
    ...
    <div class="shortcut cu-span">    
      <a href="javascript:void(0);" onclick="downcache()" target="right"><span><?php echo L('update_database')?></span></a> 
...
function downcache() {
	if (confirm('确定同步数据...'))
		location.href = '?m=admin&c=cache_all&a=up_database&pc_hash='+pc_hash+'&goback='+BASE64.encode(location.search);
	return;
}
