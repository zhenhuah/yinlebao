...
<div class="table-list">
    <table width="100%" cellspacing="0">
        <thead>
            ...
            <th width="10%"  align="left" style="color:blue;">终端类型</th>
            <th width="10%"  align="left" style="color:blue;">推荐位类型</th>
...
?>   
	...
	<td width="10%"  align="left" style="color:blue;"><?php echo $go3c_term_type['title']?></td>
	<td width="10%"  align="left" style="color:blue;"><?php echo $go3c_position_type['title']?></td>
	<td width=""  align="left" style="color:blue;"><?php echo $info['title']?> <?php if($info['thumb']!='') {echo '<img src="'.IMG_PATH.'icon/small_img.gif">'; }?></td>
