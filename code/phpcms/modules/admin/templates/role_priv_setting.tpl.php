      ...
      <h6><img src="<?php echo IMG_PATH?>icon/sitemap-application-blue.png" width="16" height="16" /> <?php echo L('site_select');?></h6>
       <div id="site_list">
          ...
          <?php foreach($sites_list as $n=>$r) {?>
            ...
            <li><a href="?m=admin&c=role&a=role_priv&siteid=<?php echo $r['siteid']?>&roleid=<?php echo $roleid?>" target="role"><span><img src="<?php echo IMG_PATH?>icon/gear_disable<?php echo $green?>.png" width="16" height="16" /><?php echo L('priv_setting');?></span><em><?php echo $r['name']?></em></a></li>
           <?php } ?>
      </ul>
      </div>
    </div>
