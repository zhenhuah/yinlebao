...
define('TASK_IMG_PATH','http://192.168.150.91:80/go3cadmin/');
//define('TASK_IMG_PATH','http://go3c.jdjkcn.net/');

//本地的客户端的图片域名(项目域名)(同步的时候用)
define('TASK_IMG_PATH_Local','http://192.168.150.91:80/go3cadmin/');
...
class task extends admin {
	...
	*/
	...
	{
		$absolute_path	= $_SERVER['DOCUMENT_ROOT'].'/go3cadmin/';
		//$absolute_path	= $_SERVER['DOCUMENT_ROOT'].'/';
		$error = "";
		$msg = "";
		$fileElementName = 'fileToUpload';
