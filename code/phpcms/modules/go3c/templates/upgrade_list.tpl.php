...
<div class="table-list">
    <table width="100%" cellspacing="0" id="i_table_list_1">
        <thead>
            <tr>
				...
				<th width='10' align="center">版本状态</th>
	...
	<td align="center"><?php echo $value['is_mode']=='1' ? '全量' : '增量'?></td>
	...
	<a href="javascript:verdel('<?php echo $value['id']?>')" onclick="return confirm('确定删除么？')">删除</a></td>
	</tr>
	<?php }} ?>
</tbody>
    </table>
