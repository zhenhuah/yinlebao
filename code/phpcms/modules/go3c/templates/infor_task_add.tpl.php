...
?>
<form name="myform" id="myform" action="?m=go3c&c=task&a=addinfortaskdo&pc_hash=<?php echo $_SESSION['pc_hash'];?>" method="post" enctype="multipart/form-data"  onSubmit="return runVideoTask();">
...
<table width="100%" cellspacing="0" class="table_form">
	<tbody>	
		...
		<tr>
		  <th width="80"> 视频简介:</th>
		  <td>
		  <input type="text" class="measure-input  input-text" value="<?php echo $videoInfo['content']?>"  name="videoDesc" id="videoDesc" style="width:280px;"></td>
		</tr>
		<tr>
		  <th width="80"> 详细介绍:</th>
		  <td><textarea rows="5" cols="41" name="long_desc" id="long_desc"><?php echo $videoInfo['description'];?></textarea></td>
		</tr>
		<tr>
		  <th width="90">资讯链接:</th>
		  <td><input type="text" class="measure-input  input-text" value="<?php echo $videoInfo['infor_url']?>"  name="infor_url" id="infor_url" style="width:280px;"></td>
		</tr>
