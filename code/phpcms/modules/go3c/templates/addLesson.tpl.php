						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab_0">
								<div class="">
									...
									<h><strong>添加课程：</strong></h>
										<!-- BEGIN FORM-->
										<form name="myform" action="?m=go3c&c=tvuser&a=addLesson" method="post" id="myform" class="form-horizontal">
											<div class="form-body">
												<div class="form-group">
													<label class="col-md-3 control-label">选择套餐 </label>
													<div class="col-md-4">
															<p class="dys"><select name="" id="" onchange="document.getElementById('plan').value=this.value;">
															 <option value=""></option>													
															 <option value="1">A套餐</option>
															 <option value="2">B套餐</option>
															 <option value="3">C套餐</option>
															 <option value="4">D套餐</option>
															 <option value="5">E套餐</option>
															</select></p>
															<p class="dyw"><input type="text" name="plan" id="plan" value="<?php echo $plan ?>" /></p>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-4">
														...
														<select name="oks1" id="oks1" onchange="document.getElementById('qishu').value=this.value;">
															...
															<p class="dyw"><input type="text" name="episode" id="qishu" value="<?php echo $episode?>" /></p>
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label">课程名称</label>
													<div class="col-md-4">
														<input type="text" name="title" id="classname"  class="form-control input-circle" value="<?php echo $title?>">
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-4">
														<div class="input-icon">
															...
															<input type="text" value="<?php echo $imageurl?>" name="imageurl" id="imageurl" class="form-control input-circle">
														</div>
													</div>
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" name="bluelight_d" id="linking"  class="form-control input-circle" value="<?php echo $bluelight_d?>">
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label">超清链接</label>
													<div class="col-md-4">
														<input type="text" name="super_d" id="link"  class="form-control input-circle" value="<?php echo $super_d?>">
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label">高清链接</label>
													<div class="col-md-4">
														<input type="text" name="high_d" id="link"  class="form-control input-circle" value="<?php echo $high_d?>">
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label">标清链接</label>
													<div class="col-md-4">
														<input type="text" name="standard_d" id="link"  class="form-control input-circle" value="<?php echo $standard_d?>">
													</div>
												</div>
											</div>
...
<script type="text/javascript">
  $(document).ready(function() {
	...
	$("#qishu").formValidator({onshow:"<?php echo L('请输入或者选择').L('期数')?>",onfocus:"<?php echo L('请输入或者选择').L('期数')?>"}).inputValidator({min:3,max:20,onerror:"<?php echo L('期数').L('3-20字符')?>"})
