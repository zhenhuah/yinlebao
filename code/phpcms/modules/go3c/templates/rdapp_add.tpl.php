...
<form name="myform" id="myform" action="?m=go3c&c=task_shop&a=add_rdappdo&pc_hash=<?php echo $_SESSION['pc_hash'];?>" method="post" enctype="multipart/form-data" onSubmit="return subapk();">
	...
	<table width="100%" cellspacing="0" class="table_form">
		  ...
		  <td>
			<select name="type" id="type">
		 	...
		 	<?php {foreach($type_list as $key=>$list){?>
		  	<option value="<?php echo $list['type']?>"><?php echo $list['type']?></option>
		  	<?php }} ?>
		  	</select>
		...
		<tr>
			<th width="80"><?php echo L('shop_pagename');?></th>
				<td>
				<input type="text" value="" name="classname" id="classname" size="25" >
				<span id="ad_classname" style="display:none"><font color="red"><?php echo L('shop_1');?></font></span>
				</td>
		</tr>
		<tr id="view_ImgText1" >
		  <th width="90"> <?php echo L('shop_icon_link');?> </th>
		  <td>
		  <input type="hidden" name="imgType1" id="ImgText1" value="ImgText">
			<input type="text" value="" name="ad_imgUrl1" id="ad_imgUrl1" size="100" >	
				 </td>
		</tr>
		<tr>
...
<div  style="float:right">	
	<input type="hidden" name="mode" id="mode" value="add_rdappdo" />
