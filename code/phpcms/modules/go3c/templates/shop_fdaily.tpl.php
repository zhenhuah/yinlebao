...
<input type="hidden" value="fdailylist" name="a">
...
<table width="100%" cellspacing="0" class="search-form">
    <tbody>
		...
		<div class="explain-col">
			...
			有线mac地址：<input name="qq" type="text" value="<?php if(isset($qq)) echo $qq;?>" class="input-text" size="20" />&nbsp;
			系统：<input name="system" type="text" value="<?php if(isset($system)) echo $system;?>" class="input-text" size="12" />&nbsp;
...
<div class="table-list">
    <table width="100%" cellspacing="0" id="i_table_list_1">
        <thead>
			...
			<th width='60' align="center">有线mac地址</th>
			<th width='60' align="center">操作系统</th>
			<th width='60' align="center">客户端版本</th>
			<th width='60' align="center">平台</th>
	...
	<td align="center"><?php echo $value['carid']?></td>
	<td align="center"><?php echo $value['mac_wire']?></td>
	<td align="center"><?php echo $value['system']?></td>
...
function detail(id) {
    location.href ='?m=go3c&c=auth&a=fdailylistdetail&id='+id+'&pc_hash='+pc_hash
...
function detail(id){
	$.ajax({
			type: "GET",
			url: 'index.php?m=go3c&c=auth&a=fdailylistdetail&id='+id+'&pc_hash='+pc_hash,
