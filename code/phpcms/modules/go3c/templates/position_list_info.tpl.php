...
<input type="hidden" value="position_info" name="c">
...
?>   
	...
	<?php } else {?>
	<a href="javascript:confirmurl('?m=go3c&c=position_info&a=delete&posid=<?php echo $info['posid']?>', '<?php echo L('posid_del_cofirm')?>')"><?php echo L('delete')?></a>	
	<?php } ?>
    </td>
