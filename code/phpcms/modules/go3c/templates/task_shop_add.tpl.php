...
?>
<form name="myform" id="myform" action="?m=go3c&c=task_shop&a=<?php echo $taskType;?>&pc_hash=<?php echo $_SESSION['pc_hash'];?>" method="post">
...
<div class="content pad-6">
	<table width="100%" cellspacing="0" class="table_form">
		...
		<tr>
		  ...
		  <td>
		  <select name="task_typeid" id="task_typeid">
				<option value="">请选择</option>
				<?php if(!empty($position_type_list)){foreach($position_type_list as $row){?>
