...
<form name="myform" id="myform" action="?m=go3c&c=shop&a=shop_editmenudo&pc_hash=<?php echo $_SESSION['pc_hash'];?>" method="post" enctype="multipart/form-data" onSubmit="return menu_form();">
...
<div class="content pad-6">
	<table width="100%" cellspacing="0" class="table_form">
		...
		<tr>
		  <th width="80">菜单名:</th>
		  <td>		
		  <input type="text" value="<?php echo $menu['m_name_zh'] ?>" name="m_name_zh" id="m_name_zh" size="25" > <font color="red">*</font>
		...
		<tr>
		  ...
		  <td>		
		  <input type="text" value="<?php echo $menu['m_name_en'] ?>" name="m_name_en" id="m_name_en" size="25" >
		</td>
		</tr>
		<tr>
		  <th width="80">菜单编号:</th>
		  <td>		
		  <input type="text" value="<?php echo $menu['m_key'] ?>" name="m_key" id="m_key" size="25" >
		</td>
		</tr>
		<tr>
		  <th width="80">应用包名:</th>
		  <td>		
		  <input type="text" value="<?php echo $menu['m_packagename'] ?>" name="m_packagename" id="m_packagename" size="25" >
		</td>
		</tr>
		<tr>
		  <th width="80">排序:</th>
		  <td>		
		  <input type="text" value="<?php echo $menu['m_seq'] ?>" name="m_seq" id="m_seq" size="25" >(排序规则:数字小排前面)
		</td>
		</tr>
		<tr id="view_ImgText" >
		  ...
		  <input type="hidden" value="<?php echo TASK_IMG_PATH;?>" name="webSiteUrl" id="webSiteUrl" >
			<input type="text" value="<?php echo $menu['m_icon'] ?>" name="ad_imgUrl" id="ad_imgUrl" size="100" >	
				 </td>
		</tr>
		<tr>
