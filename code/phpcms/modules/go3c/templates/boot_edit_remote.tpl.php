...
?>
<form name="myform" id="myform" action="?m=go3c&c=boot&a=editremotedo&pc_hash=<?php echo $_SESSION['pc_hash'];?>" method="post" enctype="multipart/form-data" onSubmit="return checkAdTaskad();">
	...
	<table width="100%" cellspacing="0" class="table_form">
		...
		<tr id="view_ImgText" >
		  ...
		  <input type="hidden" value="<?php echo TASK_IMG_PATH;?>" name="webSiteUrl" id="webSiteUrl" >
			<input type="text" value="<?php echo $remote['siurl'];?>" name="ad_imgUrl" id="ad_imgUrl" size="25" >	
		...
		<tr>
		  ...
		  <td>
		  <input type="text" value="<?php echo $remote['remote'];?>" name="remote" id="remote" size="25" >
		  </td>
		</tr>
		<tr>
		  <th width="90"><font color="red">*</font>键值内容 </th>
		  <td>
		  <textarea rows="8" cols="41" name="contetdec" id="contetdec"><?php echo $remote['contetdec'];?></textarea>
		  </td>
		</tr>
		<tr>
		  <th width="90">语言 </th>
		  <td>
		  <?php echo $remote['lang'];?>
		  </td>
		</tr>
		<tr>
		  <th width="90"><font color="red">*</font>所属项目 </th>
		  <td>
		  <?php echo $remote['spid'];?>
		  </td>
		</tr>
		</tbody>
	</table>
...
<div  style="float:right">	
	...
	<input type="hidden" name="id" id="id" value="<?php echo $remote['id'];?>" />
