...
<input type="hidden" value="click" name="a">
...
<table width="100%" cellspacing="0" class="search-form">
    <tbody>
		...
		用户id：<input name="user_id" type="text" value="<?php if(isset($user_id)) echo $user_id;?>" class="input-text" />
...
<div class="table-list">
    <table width="100%" cellspacing="0">
        <thead>
            <tr>
			<th width="15" align="center">视频id</th>
			<th width="15" align="center">用户id</th>
			<th width="10" align="center">设备编号</th>
			<th width='5' align="center">设备类型</th>
			<th width='10' align="center">播放时长</th>
			<th width='5' align="center">客户端版本</th>
    ...
    <tbody>
    <?php if(is_array($data)){foreach($data as $click){?>   
	<tr>
	<td align="center"><?php echo $click['vid']?></td>
	<td align="center"><?php echo $click['user_id']?></td>
	<td align="center"><?php echo $click['device_code']?></td>
	<td align="center"><?php echo devicetype($click['device_type'])?></td>
	<td align="center"><?php echo $click['play_seconds']?></td>
	<td align="center"><?php echo $click['client_version']?></td>
	<td align="center"><?php echo $click['area']?></td>
	<td align="center"><?php echo $click['ip']?></td>
	<td align="center"><?php echo $click['operation_time']?></td>
	</tr>
	<?php }} ?>
	</tbody>
    </table>
