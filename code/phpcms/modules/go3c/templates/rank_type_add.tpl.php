...
?>
<form name="myform" id="myform" action="?m=go3c&c=ktv&a=addRankTypedo&pc_hash=<?php echo $_SESSION['pc_hash'];?>" method="post" enctype="multipart/form-data" onSubmit="return checkAdrank();">
...
<div class="content pad-6">
	<table width="100%" cellspacing="0" class="table_form">
		...
		<tr>
		  ...
		  <td>
		  <input type="text" value="" name="ranktype_name" id="ranktype_name" size="25" >
		...
		<tr>
		  ...
		  <td>
		  <input type="text" value="" name="seq_num" id="seq_num" size="25" >
		  </td>
		</tr>
		</tbody>
	</table>
...
<div  style="float:right">	
	<input type="hidden" name="mode" id="mode" value="addRankTypedo" />
