...
<input type="hidden" value="show_notice" name="a">
...
function doCKALL(){
    ...
    if(str!=''){
    	...
    	if(doitem == '2'){  
			...
			location.href ='?m=go3c&c=tvuser&a=delete_noticeall&id='+str+'&pc_hash='+pc_hash
...
function addnew(){
	location.href ='?m=go3c&c=tvuser&a=addNotice&catid=&pc_hash='+pc_hash
	+'&goback='+BASE64.encode(location.search);
}
function dodelete(id) {
    location.href ='?m=go3c&c=tvuser&a=delete_notice&id='+id+'&pc_hash='+pc_hash
	+'&goback='+BASE64.encode(location.search);
}
function edit(id){
	location.href ='?m=go3c&c=tvuser&a=notice_edit&id='+id+'&pc_hash='+pc_hash+'&goback='+BASE64.encode(location.search);
}
</script>
