...
?>
<form name="myform" id="myform" action="?m=go3c&c=ktv&a=addrun_songdo&pc_hash=<?php echo $_SESSION['pc_hash'];?>" method="post" enctype="multipart/form-data">
...
<div class="content pad-6">
	<table width="100%" cellspacing="0" class="table_form">
		...
		<tr>
		  ...
		  {
		  	echo $info['vid'];
		  }elseif ($type_id == 'singer')
		  {
		  	echo $info['sid'];
		  }elseif ($type_id == 'album')
		  {
		  	echo $info['aid'];
		  }?> </td>
		</tr>
		...
		<tr>
		  <th width="90">推荐标题:</th>
		  <td>
		  <input type="text" value="<?php echo $info['name'];?>" name="fname" id="fname" size="25" >
		  </td>
		</tr>
		<tr>
		  <th width="90">简单介绍:</th>
		  <td>
		 <textarea rows="5" cols="41" name="subtitle" id="subtitle"><?php echo $info['name'];?></textarea>
		  </td>
		</tr>
		<tr id="view_ImgText" >
...
<input type="hidden" id="rid_id" name="rid_id" value="<?php echo $rid_id;?>" /> 
