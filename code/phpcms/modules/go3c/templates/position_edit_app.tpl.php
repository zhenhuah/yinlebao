...
<form name="myform" action="?m=go3c&c=position_app&a=edit" method="post" id="myform">
...
<option value="<?php echo $sp['board_type']?>" <?php echo (($board_type==$sp['board_type']) ? 'selected="selected"' : '')?>><?php echo $sp['board_type']?></option>
<?php }	?>
</select>
</td>
</tr>
