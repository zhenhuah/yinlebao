...
<form name="myform" id="myform" action="?m=go3c&c=auth&a=shop_addspeeddo&pc_hash=<?php echo $_SESSION['pc_hash'];?>" method="post" enctype="multipart/form-data">
...
<div  style="float:right">
	<input type="hidden" name="mode" id="mode" value="shop_addspeeddo" />
