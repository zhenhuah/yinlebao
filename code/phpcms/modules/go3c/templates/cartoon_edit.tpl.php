						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab_0">
								<div class="">
									...
									<h><strong>编辑动画：</strong></h>
										<!-- BEGIN FORM-->
										<form name="myform" action="?m=go3c&c=tvuser&a=cartoon_editdo" method="post" id="myform" class="form-horizontal">
											<div class="form-body">
												<div class="form-group">
													<label class="col-md-3 control-label">名称</label>
													<div class="col-md-4">
														<input type="text" name="title" id=""  class="form-control input-circle" value="<?php echo $ctdata['title']?>">
													</div>
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<div class="input-icon">	
															...
															<input type="text" value="<?php echo $ctdata['poster_list']?>" name="poster_list" id="imageurl" class="form-control input-circle">
														</div>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<div class="input-icon">	
															<input type="hidden" name="imgType" id="ImgText" value="ImgText">
															<input type="hidden" value="<?php echo TASK_IMG_PATH;?>" name="webSiteUrl" id="webSiteUrl" >
															<input type="text" value="<?php echo $ctdata['bigpic_list']?>" name="bigpic_list" id="imageurl" class="form-control input-circle" style="height:200px">
														</div>
													</div>
												</div>
												<div style="text-align: center; margin-left: -186px;margin-top: -14px;">
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" name="descs" id=""  class="form-control input-circle" value="<?php echo $ctdata['descs'] ?>"style='height:80px'>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-4">
															...
															<p class="dyw"><input type="text" name="okw" id="okw" value="<?php echo $ct_ldata['episode']?>" /></p>
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label">蓝光链接</label>
													<div class="col-md-4">
														<input type="text" name="bluelight_d" id="bluelight_d"  class="form-control input-circle" value="<?php echo $ct_ldata['bluelight_d'] ?>">
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label">超清链接</label>
													<div class="col-md-4">
														<input type="text" name="super_d" id="super_d"  class="form-control input-circle" value="<?php echo $ct_ldata['super_d'] ?>">
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label">高清链接</label>
													<div class="col-md-4">
														<input type="text" name="high_d" id="high_d"  class="form-control input-circle" value="<?php echo $ct_ldata['high_d']?>">
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label">标清链接</label>
													<div class="col-md-4">
														<input type="text" name="standard_d" id="standard_d"  class="form-control input-circle" value="<?php echo $ct_ldata['standard_d'] ?>">
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label">发布日期</label>
													<div class="col-md-4">
														<input type="text" value="<?php $ctdata['publish_time']?>" name="publish_time" id="publish_time" size="10" class="date" style="height:28px">
