...
?>
<form name="myform" id="myform" action="?m=go3c&c=game&a=editTaskdo&pc_hash=<?php echo $_SESSION['pc_hash'];?>" method="post" onSubmit="return checkTask('<?php echo $taskType;?>');">
...
<div class="content pad-6">
	<table width="100%" cellspacing="0" class="table_form">
		...
		<tr>
		  ...
		  <td>
		  <?php echo $gtaskInfo['posidInfo']?>
		  </td>
		</tr>
		<tr>
		  <th width="90"> <font color="red">*</font>海报类型 </th>
		  <td><?php echo $gtaskInfo['imgType']?></td>
		</tr>
		<tr>
...
<div  style="float:right">	
	...
	<input type="hidden" name="taskId" id="taskId" value="<?php echo $gtaskInfo['taskId']?>" />
