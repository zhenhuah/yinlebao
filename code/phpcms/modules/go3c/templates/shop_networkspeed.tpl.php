    ...
    <table width="100%" cellspacing="0" id="i_table_list_1">
        <thead>
            <tr>
				...
				<th width='30' align="center">名字</th>
...
function addnew(){
	$.ajax({
			type: "GET",
			url: 'index.php?m=go3c&c=auth&a=shop_addspeed&pc_hash='+pc_hash,
...
function delip(id) {
    location.href ='?m=go3c&c=auth&a=shop_delspeed&id='+id+'&pc_hash='+pc_hash
	+'&goback='+BASE64.encode(location.search);
}
function edit(id){
	$.ajax({
			type: "GET",
			url: 'index.php?m=go3c&c=auth&a=shop_editspeed&id='+id+'&pc_hash='+pc_hash,
			success: function(msg){
				art.dialog({
					content: msg,
					title:'编辑',
