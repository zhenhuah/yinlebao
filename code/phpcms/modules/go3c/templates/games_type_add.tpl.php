...
?>
<form name="myform" id="myform" action="?m=go3c&c=games&a=add_shop_type_do&pc_hash=<?php echo $_SESSION['pc_hash'];?>" method="post" enctype="multipart/form-data" onSubmit="return verify_form();">
...
<div class="content pad-6">
	<table width="100%" cellspacing="0" class="table_form">
		...
		<tr>
		  <th width="90">状态</th>
		  <td>
		  <input type="text" value="" name="status" id="status" size="25" >
		  </td>
		</tr>
		<tr>
		  <th width="90">url</th>
		...
		<tr>
		  <th width="90">备注</th>
		  <td>
		  <input type="text" value="" name="remark" id="remark" size="25" >
		  </td>
		</tr>
		</tbody>
	</table>
