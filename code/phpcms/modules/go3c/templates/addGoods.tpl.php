						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab_0">
								<div class="">
									...
									<h><strong>添加商品：</strong></h>
										<!-- BEGIN FORM-->
										<form name="myform" action="?m=go3c&c=tvuser&a=addGoods" method="post" id="myform" class="form-horizontal">
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
															...
															<p class="dyw"><input type="text" name="type" id="okw" value="<?php echo $type?>" /></p>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" name="name" id=""  class="form-control input-circle" value="<? echo $name?>">
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label">商品编号</label>
													<div class="col-md-4">
														<input type="text" name="sign" id=""  class="form-control input-circle" value="<?php echo $sign?>">
													</div>
													</div>
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<div class="input-icon">	
															<input type="hidden" name="imgType" id="ImgText" value="ImgText">
															<input type="hidden" value="<?php echo TASK_IMG_PATH;?>" name="webSiteUrl" id="webSiteUrl" >
															<input type="text" value="<?php echo $imageurl?>" name="info[imageurl]" id="imageurl" class="form-control input-circle" style="height:200px">
														</div>
													</div>
												</div>
												<div style="text-align: center; margin-left: -186px;margin-top: -14px;">
												...
												<div class="form-group">
													...
													<div class="col-md-4" style="width:12%">
														<input type="text" name="vip_price" id=""  class="form-control input-circle" value="<?php echo $vip_price ?>">
												...
												<div class="form-group">
													...
													<div class="col-md-4" style="width:12%">
														<input type="text" name="member_price" id=""  class="form-control input-circle" value="<?php echo $member_price?>">
														<span class="money"style="float: right;margin-top: -25px;position: relative; left: 28px;">元</span>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-4" style="width:12%">
														<input type="text" name="default_price" id=""  class="form-control input-circle" value="<?php echo $default_price ?>">
														<span class="money"style="float: right;margin-top: -25px;position: relative; left: 28px;">元</span>
													</div>
													<input type="text" name="createdtime" id="createdtime"  class="form-control input-circle" value="<?php echo date('Y-m-d H:i:s')?>" style='display: none'> 
												</div>
											</div>
