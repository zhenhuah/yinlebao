...
<input type="hidden" value="cuser" name="a">
...
<div class="table-list">
    <table width="100%" cellspacing="0">
        <thead>
			...
			<th width='5' align="center">是否新用户</th>
			<th width='10' align="center">客户端版本</th>
			<th width='5' align="center">区域</th>
			<th width='10' align="center">ip</th>
			<th width='10' align="center">操作时间</th>
            </tr>
        </thead>
    <tbody>
    <?php if(is_array($data)){foreach($data as $cuser){?>   
	<tr>
	<td align="center"><?php echo $cuser['user_id']?></td>
	<td align="center"><?php echo $cuser['device_code']?></td>
	<td align="center"><?php echo devicetype($cuser['device_type'])?></td>
	<td align="center"><?php echo isnewuser($cuser['user_sign'])?></td>
	<td align="center"><?php echo $cuser['client_version']?></td>
	<td align="center"><?php echo $cuser['area']?></td>
	<td align="center"><?php echo $cuser['ip']?></td>
	<td align="center"><?php echo $cuser['operation_time']?></td>
	</tr>
	<?php }} ?>
	</tbody>
    </table>
