							...
							<div class="tab-pane active" id="tab_0">
								<div class="">
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form name="myform" action="?m=go3c&c=tvuser&a=addAdvert" method="post" id="myform" class="form-horizontal">
											<div class="form-body">
												<div class="form-group">
													<label class="col-md-3 control-label">开机广告</label>
													<div class="col-md-4">
														<input style="width:80%"type="text" name="open_video" id=""  class="form-control input-circle" value="<?php echo $open_video?>">
													</div>
												</div>
												...
												<div class="form-group">
													<label class="col-md-3 control-label">暂停广告</label>
													<div class="col-md-4">
												...
												<div style="text-align: center; margin-left: -186px;margin-top: -14px;">
													<h>图片尺寸800x600px 大小800KB以内 格式：jpg</h>
												</div>
												<div class="form-group">
											...
											<div class="form-actions">
												<div class="row">
													<div class="col-md-offset-3 col-md-9">
														 ...
														 <a class="cancel" onclick="history.go(0)">取消</a>
													</div>
												</div>
											</div>
										</form>
