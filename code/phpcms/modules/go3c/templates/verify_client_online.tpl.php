...
<input type="hidden" value="client_online" name="a">
...
function dopass(id, title) {
    location.href ='?m=go3c&c=verify&a=client_online_pass&id='+id+'&pc_hash='+pc_hash
	+'&goback='+BASE64.encode(location.search);
}
function dorefuse(id, title) {
    location.href ='?m=go3c&c=verify&a=client_online_refuse&id='+id+'&pc_hash='+pc_hash
	+'&goback='+BASE64.encode(location.search);
}
function addnew(){
