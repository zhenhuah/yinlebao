						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab_0">
								<div class="">
									...
									<h><strong>添加通知：</strong></h>
										<!-- BEGIN FORM-->
										<form name="myform" action="?m=go3c&c=tvuser&a=addNotice" method="post" id="myform" class="form-horizontal">
											<div class="form-body">
												<div class="form-group">
													<label class="col-md-3 control-label">标题</label>
													<div class="col-md-4">
														<input style="width:80%"type="text" name="title" id=""  class="form-control input-circle" value="<?php echo$title?>">
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label" >添加文字</label>
													<div class="col-md-4">
														<textarea name="descs"rows="3" cols="20"style="width: 100%;border-radius: 10px !important;border-color: rgba(0,0,0,0.1);"><?php echo $descs?></textarea>
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label">编号</label>
													<div class="col-md-4">
														<input type="text" name="sign" id="sign"  class="form-control input-circle" value="<?php echo $sign ?>">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" name="video" id="video"  class="form-control input-circle" value="<?php echo $video?>">
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label">推送日期</label>
													<div class="col-md-4">
														<input type="text" value="<?php echo $publish_time;?>" name="publish_time" id="publish_time" size="10" class="date" style="height:28px">
