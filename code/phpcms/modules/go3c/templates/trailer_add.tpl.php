...
?>
<form name="myform" id="myform" action="?m=go3c&c=video&a=traileradddo&pc_hash=<?php echo $_SESSION['pc_hash'];?>" method="post" enctype="multipart/form-data" onSubmit="return subtitle();">
...
<div class="content pad-6">
	<table width="100%" cellspacing="0" class="table_form">
		...
		<tr>
		  ...
		  <td><input type="text" value="" name="tid" id="tid" size="20" ></td>
		</tr>
		<tr>
		...
		<tr>
		  <th width="80">清晰度:</th>
		  <td>		
		  <input type="text" value="" name="quality" id="quality" size="25" >(清晰度:1=low,2=medium,3=high,4=HD)
		</td>
		</tr>
		<tr>
		  <th width="80">画质:</th>
		  <td>		
		  <input type="text" value="" name="aspect" id="aspect" size="25" >
		</td>
		</tr>
		<tr>
		  <th width="90">视频来源</th>
		...
		<tr>
		  ...
		  <td>		
		  <input type="text" value="" name="play_url" id="play_url" size="50" >
		...
		<tr>
		  <th width="80">尺寸:</th>
		  <td>		
		  <input type="text" value="" name="ratio" id="ratio" size="25" >(4:3,16:9)
		</td>
		</tr>
		<tr>
		  <th width="80">视频格式:</th>
		  <td>		
		  <input type="text" value="" name="format" id="format" size="25" >(m3u8,flv....)
		</td>
		</tr>
		<tr>
		  <th width="80">视频协议:</th>
		  <td>		
		  <input type="text" value="" name="protocol" id="protocol" size="25" >(http,rstp....)
		</td>
		</tr>
		<tr>
		  <th width="90">语言类型</th>
...
<div  style="float:right">	
	<input type="hidden" name="mode" id="mode" value="traileradddo" />
