...
<input type="hidden" value="show_cartoon" name="a">
...
<table width="100%" cellspacing="0" class="search-form">
	...
	<tr>
		...
		<div class="explain-col">
			名称：<input id= "name" name="title" type="text" value="<?php if(isset($title)) echo $title;?>" class="input-text" size="15"/>&nbsp;
...
function doCKALL(){
    ...
    if(str!=''){
    	...
    	if(doitem == '2'){  
			...
			location.href ='?m=go3c&c=tvuser&a=delete_cartoonall&id='+str+'&pc_hash='+pc_hash
...
function addnew(){
	location.href ='?m=go3c&c=tvuser&a=addCartoon&catid=&pc_hash='+pc_hash
	+'&goback='+BASE64.encode(location.search);
}
function dodelete(id) {
    location.href ='?m=go3c&c=tvuser&a=delete_cartoon&id='+id+'&pc_hash='+pc_hash
	+'&goback='+BASE64.encode(location.search);
}
function edit(id){
	location.href ='?m=go3c&c=tvuser&a=cartoon_edit&id='+id+'&pc_hash='+pc_hash+'&goback='+BASE64.encode(location.search);
}
</script>
