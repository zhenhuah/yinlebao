...
<form name="myform" id="myform" action="?m=go3c&c=auth&a=add_codedo&pc_hash=<?php echo $_SESSION['pc_hash'];?>" method="post" enctype="multipart/form-data" onSubmit="return subtitle();">
...
<div class="content pad-6">
	<table width="100%" cellspacing="0" class="table_form">
		...
		<tr>
		  ...
		  <td>		
		 	<select id="type_id" name="type_id">
				...
				<option value='<?php echo $ptvalue['ID']?>'><?php echo $ptvalue['ID']?></option>
				<?php }?>
			</select>
		...
		<tr>
		  ...
		  <td>
		  <input type="text" value="" name="title" id="title" size="10" >
...
<div  style="float:right">	
	<input type="hidden" name="mode" id="mode" value="add_codedo" />
