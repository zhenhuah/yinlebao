...
<input type="hidden" value="interfacelog" name="a">
...
<table width="100%" cellspacing="0" class="search-form">
	...
	<tr>
		...
		<div class="explain-col">
			接口名：<input name="url" type="text" value="<?php if(isset($url)) echo $url;?>" class="input-text" size="20"/>&nbsp;
...
<div class="table-list">
    <table width="100%" cellspacing="0" id="i_table_list_1">
        <thead>
            <tr>
				...
				<th style="width:100px; word-break: break-all; word-wrap:break-word;" align="left">接口名</th>
				<th style="width:300px; word-break: break-all; word-wrap:break-word;" align="left">返回值</th>
	...
	<td align="center">
	<?php if($v['type']=='info') echo "正常"?>
	<?php if($v['type']=='error') echo "错误"?></td>
	<td style="width:100px; word-break: break-all; word-wrap:break-word;" align="left"><?php echo $v['url'];?></td>
	<td style="width:300px; word-break: break-all; word-wrap:break-word;" align="left"><?php echo $v['content'];?></td>
