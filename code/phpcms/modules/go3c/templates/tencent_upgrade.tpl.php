...
<input type="hidden" value="tencent_upgrade" name="a">
...
<table width="100%" cellspacing="0" class="search-form">
    <tbody>
		...
		<div class="explain-col">
			<a href="?m=go3c&c=client&a=tencent_upgrade"><?php echo L('all')?></a>&nbsp;
...
function addnew() {
    location.href ='?m=go3c&c=client&a=add_upgrade_tencent&pc_hash='+pc_hash
