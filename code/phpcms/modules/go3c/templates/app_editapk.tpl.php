...
<form name="myform" id="myform" action="?m=go3c&c=task_shop&a=edit_appapkdo&pc_hash=<?php echo $_SESSION['pc_hash'];?>" method="post" enctype="multipart/form-data" onSubmit="return subtitle();">
	...
	<table width="100%" cellspacing="0" class="table_form">
		...
		<tr id="view_ImgText" >
		  ...
		  <input type="hidden" value="<?php echo TASK_IMG_PATH;?>" name="webSiteUrl" id="webSiteUrl" >
			<input type="text" value="<?php echo $data['install_file'] ?>" name="ad_imgUrl" id="ad_imgUrl" size="100" >	
				 </td>
		</tr>
		<tr>
...
<div  style="float:right">
	<input type="hidden" name="image_id" id="image_id" value="<?php echo $data['install_file'];?>" />
	<input type="hidden" name="app_id" id="app_id" value="<?php echo $data['app_id'];?>" />
