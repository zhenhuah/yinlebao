...
<form name="myform" action="?m=go3c&c=importspptv&a=importdetail&id={urlencode($video[id])}" method="post" id="myform">
			...
			<table width="100%" class="table_form"><tbody>
				...
				<tr>
					<td colspan="10" style="text-align:center;">
						{if $video[total_episodes]}
						<input type="button" style="width:82px;height:25px;" href="?m=go3c&c=importspptv&a=showdetaillist&id={urlencode($video[id])}&pc_hash={$_SESSION['pc_hash']}" onclick="window.location.href=this.getAttribute('href')" value="查看分集" />
						&nbsp;&nbsp;
						{/if}
