...
//富文本编辑器ckeditor 路径
define('CKEDITOR_PATH', pc_base::load_config('system', 'ckeditor_path'));
//清除接口缓存的ip路径
define('GO3C_PATH1',pc_base::load_config('system','go3c_path1'));
define('GO3C_PATH2',pc_base::load_config('system','go3c_path2'));
//手动执行接口数据
define('GO3C_PATH3',pc_base::load_config('system','go3c_path3'));
//消息推送链接配置
define('GO3C_PATH4',pc_base::load_config('system','go3c_path4'));
//导入pptv数据
define('GO3C_pptv',pc_base::load_config('system','go3c_pptv'));
//应用静态文件路径
define('PLUGIN_STATICS_PATH',WEB_PATH.'statics/plugin/');
//版本升级系统路径
define('UPGRADE_PATH',pc_base::load_config('system','upgrade_path'));
//菜单外链路径
define('menu_path',pc_base::load_config('system','menu_path'));
