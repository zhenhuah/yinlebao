...
$sql1  = "SELECT * from v9_video where column_id='3' and ispackage='1' and active='3'";
...
foreach($vod_stb as $v){
	...
	$thisd = $phpcmsdb->r1('v9_video',array('title'=>$v['title'],'column_id'=>'3'),'id') ;
...
function importgo3c($video){
	...
	if($video['parent_id']){
		...
		$d['latest_episode_number'] =  $video['latest_episode_number'];
		$d['total_episodes'] 	 	=  $video['total_episodes'];
