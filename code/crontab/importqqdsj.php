...
foreach($year as $vy){
	$f1 = 'http://tv.video.qq.com/fcgi-bin/dlib/dout_tv?auto_id=15&platform=10&version=10005&itype=-1&iarea=-1&itrailer=-1&iedition=-1&sort=1&pagesize=20&iyear='.$vy.'&page=0';
	$sxmln = afget ( $f1 );
	...
	for($i=0;$i<=$num;$i++){
		$f1 = 'http://tv.video.qq.com/fcgi-bin/dlib/dout_tv?auto_id=15&platform=10&version=10005&itype=-1&iarea=-1&itrailer=-1&iedition=-1&sort=1&pagesize=20&iyear='.$vy.'&page='.$i;
		$sxmly = afget ( $f1 );
