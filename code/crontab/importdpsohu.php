...
$f1 = 'http://tv4.hdpfans.com/~rss.get.film_xml/site/sohu/channel/tv/category/%25E7%25BE%258E%25E5%2589%25A7/rss/1/xml/1/ajax/1/key/ba3cd61e4953cecff627b1401588fb1e';
$sxml = afget ( $f1 );
...
function doa($a){
	...
	$thisd = $phpcmsdb->r1('v9_video',array('title'=>$vi['title']),'id,published,online_status') ;
	if((isset($thisv['published']) && strcmp($thisv['published'] ,'1') == 0)||(isset($thisd['published']) && strcmp($thisd['published'] ,'1') == 0)){
		//已经更新过了
		//return ;
	}
